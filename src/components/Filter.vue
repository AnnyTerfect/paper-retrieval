<template>
	...
	>
        ...
        :append-icon="titleSearch != '' ? 'mdi-close' : ''"
        @click:append="clearTitleSearch"
        @input="updateTitleSearch"
      ></v-text-field>
		</v-card-text>
        ...
        append-outer-icon="mdi-magnify"
        :append-icon="authorSearch != '' ? 'mdi-close' : ''"
        @click:append="clearAuthorSearch"
        @input="updateAuthorSearch"
      ></v-text-field>
		</v-card-text>
		...
		<v-card-text>
			...
			<v-chip
				close
				v-for="(title, index) in titleExclude"
				:key="index"
				@click:close="removeTitleExclude(index)"
				class="mb-1 mr-1"
			>
				{{ title }}
			</v-chip>
			...
			<v-text-field
				v-model="newTitleExclude"
        label="Add"
        append-outer-icon="mdi-plus"
        @keypress.enter="addNewTitleExclude"
      ></v-text-field>
		</v-card-text>
		...
		<v-card-text>
			...
			<v-chip
				close
				v-for="(title, index) in titleInclude"
				:key="index"
				@click:close="removeTitleInclude(index)"
				class="mb-1 mr-1"
			>
				{{ title }}
			</v-chip>
			...
			<v-text-field
				v-model="newTitleInclude"
        label="Add"
        append-outer-icon="mdi-plus"
        @keypress.enter="addNewTitleInclude"
      ></v-text-field>
		</v-card-text>
		...
		<v-card-text>
			...
			<v-chip
				close
				v-for="(author, index) in authorExclude"
				:key="index"
				@click:close="removeAuthorExclude(index)"
				class="mb-1 mr-1"
			>
				{{ author }}
			</v-chip>
			...
			<v-text-field
				v-model="newAuthorExclude"
        label="Add"
        append-outer-icon="mdi-plus"
        @keypress.enter="addNewAuthorExclude"
      ></v-text-field>
		</v-card-text>
		...
		<v-card-text>
			...
			<v-chip
				close
				v-for="(author, index) in authorInclude"
				:key="index"
				@click:close="removeAuthorInclude(index)"
				class="mb-1 mr-1"
			>
				{{ author }}
			</v-chip>
			...
			<v-text-field
				v-model="newAuthorInclude"
        label="Add"
        append-outer-icon="mdi-plus"
        @keypress.enter="addNewAuthorInclude"
      ></v-text-field>
		</v-card-text>
		...
		<v-card-text>
			...
			<v-chip
				close
				v-for="(abstract, index) in abstractExclude"
				:key="index"
				@click:close="removeAbstractExclude(index)"
				class="mb-1 mr-1"
			>
				{{ abstract }}
			</v-chip>
			...
			<v-text-field
				v-model="newAbstractExclude"
        label="Add"
        append-outer-icon="mdi-plus"
        @keypress.enter="addNewAbstractExclude"
      ></v-text-field>
		</v-card-text>
	</v-card>
</template>
